...
public final class updateEvents_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserBean sessionUser = (UserBean)session.getAttribute("userBean");
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("\">\n");
      out.write("\n");
      out.write("<title>工程师工作纪要 更新</title>\n");
      ...
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\tif($(\"#phonenumber\").val()==\"\" || isNaN($(\"#phonenumber\").val())) {\n");
      ...
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\tif($(\"#newcontent\").val()==\"\") {\n");
      out.write("\t\t\talert(\"更新内容不能为空!\");\n");
      out.write("\t\t\treturn;\n");
      out.write("\t\t}\n");
      out.write("\n");
      out.write("\t\tif($(\"#newcontent\").val().length > 1000) {\n");
      out.write("\t\t\talert(\"更新内容超出1000字!\");\n");
      out.write("\t\t\treturn;\n");
      out.write("\t\t}\n");
      out.write("   \t\n");
...
if (worksBean == null) {
	return;
      ...
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"titleDiv\">工作纪要更新</div>\n");
      ...
      out.write("\t\t\t<input type=\"hidden\" name=\"howdo\" value=\"update\" />\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"id\" value=\"");
      out.print(request.getAttribute("fid"));
      out.write("\" />\n");
      out.write("\t\t\t<table class=\"addContentTable\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td width=\"180px\" align=\"right\">客户:</td>\n");
      out.write("\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t<select name=\"customerid\" id=\"\" class=\"addSelect fl\" onfocus=\"this.defaultIndex=this.selectedIndex;\" onchange=\"this.selectedIndex=this.defaultIndex;\">\n");
      out.write("\t\t\t\t\t\t<option value=\"");
      out.print(worksBean.getCustomerid() );
      out.write('"');
      out.write('>');
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"erjidanwei\" id=\"erjidanwei\" class=\"addInput fl\" value=\"");
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"kehulianxiren\" id=\"kehulianxiren\" class=\"addInput fl\" value=\"");
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"lianxifangshi\" id=\"lianxifangshi\" class=\"addInput fl\" value=\"");
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"lianximail\" id=\"lianximail\" class=\"addInput fl\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t<option value=\"一级问题\" ");
 if (worksBean.getLevel().equals("一级问题")) { 
      out.write(" selected=\"true\" ");
 } 
      out.write(">一级问题</option>\n");
      out.write("\t\t\t\t\t\t\t<option value=\"二级问题\" ");
 if (worksBean.getLevel().equals("二级问题")) { 
      out.write(" selected=\"true\" ");
 } 
      out.write(">二级问题</option>\n");
      out.write("\t\t\t\t\t\t\t<option value=\"普通问题\" ");
 if (worksBean.getLevel().equals("普通问题")) { 
      out.write(" selected=\"true\" ");
 } 
      out.write(">普通问题</option>\n");
      out.write("\t\t\t\t\t\t\t<option value=\"技术咨询\" ");
 if (worksBean.getLevel().equals("技术咨询")) { 
      out.write(" selected=\"true\" ");
 } 
      out.write(">技术咨询</option>\n");
      out.write("\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td align=\"right\">事件描述(1000字以内):</td>\n");
      out.write("\t\t\t\t\t<td><textarea name=\"describe\" id=\"describe\" class=\"addArea fl\" readonly>");
      ...
      out.write("\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"isphonecall\" id=\"\" class=\"ml15\" value=\"1\" ");
 if (worksBean.isIsphonecall()) { 
      out.write(" checked=\"checked\" ");
 } 
      out.write(" /> 是 \n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"isphonecall\" id=\"\" class=\"ml15\" value=\"0\" ");
 if (!worksBean.isIsphonecall()) { 
      out.write(" checked=\"checked\" ");
 } 
      out.write("/> 否</td>\n");
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"phonenumber\" id=\"phonenumber\" class=\"addInput fl\" value=\"");
      out.print(worksBean.getPhonecallnumber() );
      out.write("\"/></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td align=\"right\">解决办法(1000字以内):</td>\n");
      out.write("\t\t\t\t\t<td><textarea name=\"solution\" id=\"solution\" class=\"addArea fl\" readonly>");
      ...
      out.write("\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"isclosed\" id=\"\" class=\"ml15\" value=\"1\" ");
 if (worksBean.getIsclosed()==1) { 
      out.write(" checked=\"checked\" ");
 } 
      out.write("/> 是 \n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"isclosed\" id=\"\" class=\"ml15\" value=\"0\" ");
 if (worksBean.getIsclosed()==0) { 
      out.write(" checked=\"checked\" ");
 } 
      out.write(" /> 否\n");
      out.write("\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td align=\"right\">更新内容(1000字以内):</td>\n");
      out.write("\t\t\t\t\t<td><textarea name=\"newcontent\" id=\"newcontent\" class=\"addArea fl\">");
