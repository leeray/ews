...
if (userBean1 == null) {
	return;
      ...
      out.write("\t\t\t\t\t<li  class=\"navcurrent\"><a href=\"/servlet/User?howdo=list&pageNum=1\">帐号管理</a></li>\n");
      out.write("\t\t\t\t</ul>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" name=\"username\" id=\"username\" class=\"addInput fl\" value=\"");
      out.print(userBean1.getName() );
      out.write("\" readonly/></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td align=\"right\">密码:</td>\n");
      out.write("\t\t\t\t\t<td><input type=\"password\" name=\"password\" id=\"password\" class=\"addInput fl\" value=\"\"/></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td align=\"right\">确认密码:</td>\n");
      out.write("\t\t\t\t\t<td><input type=\"password\" name=\"confirPassword\" id=\"confirPassword\" class=\"addInput fl\" value=\"\"/></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td align=\"right\">描述(200字以内):</td>\n");
      out.write("\t\t\t\t\t<td><textarea name=\"describe\" id=\"describe\" class=\"addArea fl\">");
